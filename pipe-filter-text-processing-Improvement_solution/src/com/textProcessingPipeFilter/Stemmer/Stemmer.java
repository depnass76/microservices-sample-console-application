package com.textProcessingPipeFilter.Stemmer;
 ...
 *
 * here: <a href="http://tartarus.org/martin/PorterStemmer/def.txt">http://tartarus.org/martin/PorterStemmer/def.txt</a>
 * 
 * This implementation is not for high performance on large amounts of text.
 *
 * Stermming filter that converts word into just their roots based on the Porter stemming algorithm
 */

public class Stemmer implements ITimer {
	...
	private String step1b2(String input) {
		...
		// IZ -> IZE
			...
			if (lastDoubleConsonant != 0 && lastDoubleConsonant != 'l' && lastDoubleConsonant != 's'
	...
	String stemStep2(String input) {
		String[] s1 = new String[] { "ational", "tional", "enci", "anci", "izer", "bli", // the published algorithm
																							// specifies abli instead of
																							// bli.
				"alli", "entli", "eli", "ousli", "ization", "ation", "ator", "alism", "iveness", "fulness", "ousness",
				"aliti", "iviti", "biliti", "logi", // the published algorithm doesn't contain this
		};
		String[] s2 = new String[] { "ate", "tion", "ence", "ance", "ize", "ble", // the published algorithm specifies
																					// able instead of ble
				"al", "ent", "e", "ous", "ize", "ate", "ate", "al", "ive", "ful", "ous", "al", "ive", "ble", "log" // the
																													// published
																													// algorithm
																													// doesn't
																													// contain
	...
	String stemStep4(String input) {
		String[] suffixes = new String[] { "al", "ance", "ence", "er", "ic", "able", "ible", "ant", "ement", "ment",
	...
	@Override
	public long getTime(String word) {
	...
	@Override
	public Long avgDuration(String filename2) {

		filename2 = "alice30.txt";
		long total = 0;
